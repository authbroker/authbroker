...
console.log(setting)
  this.salt = setting.salt
  this.db = setting.db
  if (this.db.type === 'mongo') this.lookup = require('./mongo')
  this.adapter.mqtt = setting.mqtt
  this.adapter.http = setting.http
  this.adapter.coap = setting.coap
}
...
authFind.prototype.reviewClient = function (data, secOption) {
  ...
  return new Promise(resolve => {
    ...
    self.find = new self.lookup(self.db)
